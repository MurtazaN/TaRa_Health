...
(web_app.py), the ingestion pipeline, and the blob store — and none of them
should import it from another layer.
...
def validated_file_suffix(filename: str) -> str:
    ...
    if suffix not in ALLOWED_EXTENSIONS:
        ...
        raise UploadError(
            ...
            f"Allowed: {allowed_extensions_text}."
        )
    return suffix
...
def validate_upload(filename: str, size_bytes: int) -> None:
    ...
    """
    validated_file_suffix(filename)
