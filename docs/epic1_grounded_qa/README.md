...
- **Prerequisite (added 2026-08-14):** [Epic 0 — Foundation](../epic0_foundation/README.md) M1, M2, and M3 must land **before Epic 1 M4**. Epic 0 also imposes deltas on Epic 1 M3, M4, M5, and M8 — read [Epic 0 M4 — epic1_handoff](../epic0_foundation/M4_epic1_handoff.md) before planning any of those modules. Their contracts below are otherwise unchanged.
